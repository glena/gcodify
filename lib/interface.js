...
function getParams() {
  return {
    xOffset: (program.xOffset && parseInt(program.xOffset)) || 35,
    yOffset: (program.yOffset && parseInt(program.yOffset)) || 35,
    ...
    imageBrighness: program.imageBrighness && parseInt(program.imageBrighness),
    imageContrast: program.imageContrast && parseInt(program.imageContrast),
  };
}
